...
describe('run', () => {
  test('should create files under .github', async () => {
    ...
    assert.fileContent('.github/workflows/pr_test.yml', 'adobe/aio-apps-action@2.0.0')
    assert.file('.github/workflows/deploy_prod.yml')
    assert.fileContent('.github/workflows/deploy_prod.yml', 'version: 7.x.x')
    assert.fileContent('.github/workflows/deploy_prod.yml', 'adobe/aio-apps-action@2.0.0')
    assert.file('.github/workflows/deploy_stage.yml')
    assert.fileContent('.github/workflows/deploy_stage.yml', 'version: 7.x.x')
    assert.fileContent('.github/workflows/deploy_stage.yml', 'adobe/aio-apps-action@2.0.0')
  })
})
