...
describe('implementation', () => {
  ...
  describe('addAction', () => {
    ...
    test('with e2eTestFile option', () => {
      ...
      // test manifest update with action information
      expect(actionGenerator.fs.copyTpl).toHaveBeenCalledWith(n('/fakeTplDir/template.test.js'), n(`/fakeDestRoot/e2e/${constants.actionsDirname}/myAction.e2etest.js`), { actionRelPath: n(`../../${constants.actionsDirname}/myAction/index.js`) }, {}, {})
    })
