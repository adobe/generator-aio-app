...
class ActionGenerator extends Generator {
  constructor (args, opts) {
    ...
    this.actionFolder = this.option['action-folder'] // todo ensure this is relative to root
    this.configPath = this.destinationPath(this.option['config-path'])
    this.fullKeyToManifest = this.option['full-key-to-manifest']
