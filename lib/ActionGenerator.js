...
class ActionGenerator extends Generator {
  constructor (args, opts) {
    ...
    this.runtimePackageName = path.basename(path.dirname(this.configPath)) // todo do better !

    // load and set default package name
    this.runtimeManifest = this.loadRuntimeManifest(this.configPath, this.runtimePackageName)
  }
  ...
  /** @private */
  loadRuntimeManifest (configPath, pkgName) {
