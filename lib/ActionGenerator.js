...
class ActionGenerator extends Generator {
  ...
  async promptForActionName (actionPurpose, defaultValue) {
    const [runtimeManifest, runtimePackageName] = this.loadRuntimeManifest(this.configPath, this.defaultRuntimePackageName)
  ...
  addAction (actionName, tplActionPath, options = {}) {
    ...
    this.setRuntimeManifestAction(actionName, this.actionPath, runtimeManifest, runtimePackageName, options.actionManifestConfig)
    this.writeRuntimeManifest(this.configPath, runtimeManifest)
