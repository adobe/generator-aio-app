...
/**
 * This is a sample action showcasing how to access Adobe Campaign Standard API
 *
...
async function main (params) {
  ...
  if (!params.tenant || !params.apiKey || !params.token) {
    ...
    return {
      statusCode: 400,
      body: { error: 'missing Adobe Campaign Standard credentials, required: tenant, apiKey and token' }
    }
  }
